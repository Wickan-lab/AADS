...
class Job:
    ...
    def __init__(self, priority, length, arrival_slice, executed_slice=-1):
        global varstat
        self._name = "Job" + str(varstat)
    ...
    def __str__(self):
        return "[" + str(self._name) + "]" + 'Length : ' + str(self._length) + " Priority : " + str(
            self._priority) + ' Arrived at : ' + str(self.arrival_slice)
    ...
    def greater(self, b):
        return self._priority > b.priority or \
               self._priority == b.priority and self._length > b.length or \
               self._priority == b.priority and self._length == b.length and self.arrival_slice < b.arrival_slice

    def greater_equal(self, b):
        pass

    def less(self, b):
        return not self.greater_equal()
