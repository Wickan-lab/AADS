...
class Tree:
  ...
  class Position:
    """An abstraction representing the location of a single element within a alberi.
  ...
  def is_root(self, p):
    """Return True if Position p represents the root of the alberi."""
    return self.root() == p
  ...
  def is_empty(self):
    """Return True if the alberi is empty."""
    return len(self) == 0
  ...
  def _height1(self):                 # works, but O(n^2) worst-case time
    """Return the height of the alberi."""
  ...
  def __iter__(self):
    """Generate an iteration of the alberi's elements."""
  ...
  def preorder(self):
    """Generate a preorder iteration of positions in the alberi."""
  ...
  def postorder(self):
    """Generate a postorder iteration of positions in the alberi."""
    if not self.is_empty():
